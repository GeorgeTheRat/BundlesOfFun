BundlesOfFun.Joker {
    ...
    calculate = function(self, card, context)
        if context.setting_ability and context.other_card and context.new and context.new ~= "c_base" and not context.other_card.bof_knight_enhancing then
            local targets = {}
            for _, hand_card in ipairs(G.hand.cards) do
                if hand_card ~= context.other_card and not hand_card.debuff and not hand_card.bof_knight_enhancing then
