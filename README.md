...
## Bundles
- ***1. Appetizers*** (Food Jokers, like Popcorn)  - **12 Jokers**
- ***2. Jesters*** (Regular, characterized jokers, like Chaos the Clown)  - **44 Jokers**
- ***3. Normalities*** (Real life cards; Driver's License, Business Card, etc.)  - **9 Jokers**
- ***4. Fables*** (Legendaries in one new set)  - **10 Jokers**
- ***5. Flats*** (Decks to spice up your runs or try for Gold Stake)  - **10 Decks**
- ***6. Minnows*** (Consumables made to keep, but you might get hungry...) - **12 Consumables**
- ***7. Coupons*** (Vouchers to fill your shops)  - **4 Lines of 2, 8 Vouchers**
